 ...
 * )
 * @SWG\Model(id="User",
 *   @SWG\Property(name="name",type="string",description="Displayable name of this user."),
 *   @SWG\Property(name="api_name",type="string",description="Name of the user to use in API transactions."),
 *   @SWG\Property(name="description",type="string",description="Description of this user."),
 *   @SWG\Property(name="is_active",type="boolean",description="Is this user active for use."),
