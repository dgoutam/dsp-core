 ...
 *   @SWG\Property(name="api_name",type="string",description="Name of the email template to use in API transactions."),
 *   @SWG\Property(name="description",type="string",description="Description of this email template."),
 *   @SWG\Property(name="is_active",type="boolean",description="Is this email template active for use."),
