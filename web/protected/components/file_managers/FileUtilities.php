...
class FileUtilities
{
     ...
     */
    public static $mimeExtArray = array();
    ...
    {
        $path = rtrim($path, '/'); // may be a folder
        if (empty($path)) return '.'; // self directory

        $marker = strrpos($path, '/');
        if (false === $marker) return $path;
     ...
     * @return array
     */
    public static function getMimeTypeExtensionArray()
    {
        if (!empty(static::$mimeExtArray)) return static::$mimeExtArray;
/*
        ...
        static::$mimeExtArray = @sort($s)?'$mime_types = array(<br />'.implode($s,',<br />').'<br />);':false;
*/
        static::$mimeExtArray =
               array('123' => 'application/vnd.lotus-1-2-3',
