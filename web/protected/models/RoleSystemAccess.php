 ...
 * @property Role    $role
 */
class RoleSystemAccess extends BaseDspSystemModel
{
	/**
	 ...
	 *
	 * @return RoleSystemAccess the static model class
	 */
	...
	public function rules()
	{
		return array(
			...
			array( 'id, role_id, component, access', 'safe', 'on' => 'search' ),
		);
	}
	...
	public function getRetrievableAttributes( $requested, $columns = array(), $hidden = array() )
	{
		...
		return array( 'role_id', 'component', 'access' );
	}
}