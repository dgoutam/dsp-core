...
define("E_VAL_ALNUM_S_CHECK_FAILED","Please provide an alpha-numeric or space input for %s");
define("E_VAL_ALNUM_U_CHECK_FAILED","Please provide an alpha-numeric or underline input for %s");
			...
			case 'alnum_u':
						{
							...
							if(false == $bret)
							{
								$default_error_message = sprintf(E_VAL_ALNUM_U_CHECK_FAILED,$variable_name);
							}
							break;
						}
