 ...
 *   @SWG\Operations(
 *     @SWG\Operation(
 *       httpMethod="GET", summary="List resources available for database tables.",
 ...
 * )
 * @SWG\Api(
 *   path="/{nosql_db}/admin", description="Operations for database administration.",
 *   @SWG\Operations(
 *     @SWG\Operation(
 *         httpMethod="GET", summary="Retrieve all tables.",
 *         notes="",
 ...
 *         notes="Post data should be a single table or an array of tables (shown).",
 *         responseClass="Success", nickname="createTables",
 *         @SWG\Parameters(
 *           @SWG\Parameter(
 *             name="table", description="Data containing name-value pairs of tables to create.",
 ...
 *         notes="Post data should be a single table or an array of tables (shown).",
 *         responseClass="Success", nickname="updateTables",
 *         @SWG\Parameters(
 *           @SWG\Parameter(
 *             name="table", description="Data containing name-value pairs of tables to create.",
 *             paramType="body", required="true", allowMultiple=false, dataType="NoSqlTables"
 ...
 *         notes="Use 'ids' or post data should be a single table or an array of tables (shown) containing an id.",
 *         responseClass="Success", nickname="deleteTables",
 *         @SWG\Parameters(
 *           @SWG\Parameter(
 *             name="ids", description="Comma-delimited list of the identifiers of the resources to retrieve.",
 *             paramType="query", required="false", allowMultiple=true, dataType="string"
 ...
 *
 * @SWG\Api(
 *   path="/{nosql_db}/admin/{table_name}", description="Operations for single table administration.",
 *   @SWG\Operations(
 *       @SWG\Operation(
 *         httpMethod="GET", summary="Retrieve one table by identifier.",
 *         notes="",
 *         responseClass="NoSqlTable", nickname="getTable",
 *         @SWG\Parameters(
 *           @SWG\Parameter(
 ...
 *       ),
 *       @SWG\Operation(
 *         httpMethod="PUT", summary="Update one table by identifier.",
 *         notes="Post data should be an array of properties for a single table.",
 *         responseClass="Success", nickname="updateTable",
 *         @SWG\Parameters(
 *           @SWG\Parameter(
 *             name="table_name", description="Name of the table to perform operations on.",
 *             paramType="path", required="true", allowMultiple=false, dataType="string"
 *           ),
 *           @SWG\Parameter(
 *             name="table", description="Data containing name-value pairs of tables to update.",
 *             paramType="body", required="true", allowMultiple=false, dataType="NoSqlTable"
 *           )
 *         ),
 *         @SWG\ErrorResponses(
 *            @SWG\ErrorResponse(code="400", reason="Bad Request - Request does not have a valid format, all required parameters, etc."),
 ...
 *       ),
 *       @SWG\Operation(
 *         httpMethod="DELETE", summary="Delete one table by identifier.",
 *         notes="",
...
abstract class NoSqlDbSvc extends BaseDbSvc
{
	 ...
	 * @param string $container Name of the container where the item will be stored
	 *
	 * @return string
	 */
	protected static function createItemId( $container )
	{
		...
		$_generateId = strtolower( md5( $_random1 . $container . $_randomTime . $_random2 ) );
